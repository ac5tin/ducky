...
export function PlanModal() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-6">
      ...
      <div
        className="pop-in relative flex max-h-[88vh] w-full max-w-3xl flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl dark:border-slate-700 dark:bg-slate-900"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div className="flex flex-col gap-2 border-t border-slate-100 px-5 py-3.5 dark:border-slate-800">
          ...
          <p className="text-right text-xs text-slate-400">
            Plan mode also ends if you switch the mode yourself.
          </p>
        </div>
      </div>
    </div>
