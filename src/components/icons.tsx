...
const paths: Record<string, ReactElement> = {
  duck: (
    <>
      ...
      <path
        d="M4 15 Q10 20.5 16.5 16.5 L16.5 19.5 Q10 23.5 4 18 Z"
        fill="currentColor"
        opacity="0.75"
      />
    </>
  ...
  pencil: (
    <path
      d="M4 20h4l10-10-4-4L4 16v4Zm12-12 4 4"
      stroke="currentColor"
      strokeWidth="1.6"
      strokeLinecap="round"
      strokeLinejoin="round"
  ...
  key: (
    <>
      ...
      />
      <path
        d="M11 11 20 2m-4 2 3 3m-6 0 3 3"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinecap="round"
      />
  ...
  globe: (
    <>
      ...
      />
      <path
        d="M3 12h18M12 3c2.7 2.6 4 5.7 4 9s-1.3 6.4-4 9c-2.7-2.6-4-5.7-4-9s1.3-6.4 4-9Z"
        stroke="currentColor"
        strokeWidth="1.6"
        fill="none"
      />
  ...
  terminal: (
    <>
      ...
      />
      <path
        d="m7 9 3.5 3L7 15M12.5 15.5h4.5"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
        strokeLinejoin="round"
